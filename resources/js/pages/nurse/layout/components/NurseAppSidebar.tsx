// resources/js/pages/nurse/layout/components/NurseAppSidebar.tsx
// ─────────────────────────────────────────────────────────────────────────────
// Staff Nurse sidebar — same visual spec as HRAppSidebar.
...
import type { NavItem } from '@/pages/nurse/layout/nurse-dashboard-data';
import { navGroups } from '@/pages/nurse/layout/nurse-dashboard-data';
...
interface NurseAppSidebarProps {
    activeId: string;
}

export function NurseAppSidebar({
    activeId,
}: NurseAppSidebarProps): ReactElement {
    return (
        <aside
            style={{
                width: 260,
