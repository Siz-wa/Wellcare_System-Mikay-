...
const StarIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="var(--wc-warning)" stroke="none">
          ...
          {items.map((t, i) => (
            ...
            >
              <div className="wc-card-body">
                ...
                <p className="text-base text-[var(--wc-gray-700)] leading-relaxed mb-6 italic">
                  "{t.quote}"
                </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="block font-display font-bold text-sm text-[var(--wc-dark)]">{t.name}</span>
                    <span className="block text-xs text-[var(--wc-gray-400)]">{t.role}</span>
                  </div>
                </div>
              </div>
            </div>
