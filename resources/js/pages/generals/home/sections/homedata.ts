    ...
    items: [
        {
            ...
            desc: 'Rigorous quality standards ensuring accurate, reliable diagnostic results every time.',
        },
        {
            emoji: '⚡',
            title: '24-Hour Turnaround',
            desc: 'Most lab results ready within 24 hours so your care team can act fast.',
        },
        {
            emoji: '🩺',
            title: '50+ Board-Certified Docs',
            desc: 'Access to specialists across every major medical discipline.',
        },
        {
            emoji: '💙',
            title: 'Patient-First Philosophy',
            desc: 'Every touchpoint is designed around your comfort, clarity, and confidence.',
        },
    ],
};
