            ...
            <div className="wc-container">
                <div className="grid grid-cols-1 items-start gap-16 lg:grid-cols-2">
                    ...
                    <div ref={ref} className="flex flex-col gap-4">
                        <span className="wc-pill wc-pill-primary mb-2 inline-flex">
                            Contact Details
                        </span>

                        <h2 className="mb-2 text-[clamp(1.875rem,3.5vw,2.25rem)]">
                            Reach the{' '}
                            <span className="wc-gradient-text">Right Team</span>
                        </h2>
                        <p
                                        ...
                                        <div className="flex flex-col gap-1">
                                            {ch.lines.map((line) => (
                                                <a
                                                    key={line.href}
                                                    href={line.href}
                                                    className="text-sm font-medium break-all no-underline transition-all duration-[var(--duration-fast)]"
                                                    style={{
