...
export default function StepIndicator({ current, completed }: StepIndicatorProps): ReactElement {
  return (
    <div
      style={{
        display:        "flex",
              ...
              <div
                style={{
                  ...
                  background:     isDone
                    ...
                    ? "var(--wc-blue-600)"
                    : "var(--wc-gray-100)",
                  color:          isDone || isActive ? "#ffffff" : "var(--wc-gray-400)",
                  border:         isActive
            ...
            {index < STEPS.length - 1 && (
              <div
                style={{
                  ...
                  marginBottom: 22,
                  flexShrink: 0,
                  background: isDone ? "var(--wc-blue-600)" : "var(--wc-gray-200)",
