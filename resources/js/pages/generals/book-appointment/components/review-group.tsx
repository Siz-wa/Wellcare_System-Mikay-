...
export function ReviewGroup({ iconKey, title, onEdit, children, fullWidth }: ReviewGroupProps): ReactElement {
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "var(--space-2)" }}>
          ...
          <p style={{ fontWeight: 700, fontSize: "var(--text-sm)", margin: 0, color: "var(--wc-dark)" }}>
            {title}
          </p>
        </div>
