    ...
    return (
        <section className="wc-section">
            <div className="wc-container">
                ...
                >
                    <span className="wc-pill wc-pill-primary mb-4 inline-block">
                        {pill}
                    </span>
                    <h1 className="mb-5 text-[clamp(2.25rem,5vw,3.75rem)]">
                        {heading.plain}{' '}
                        <span className="wc-gradient-text">
                            {heading.gradient}
                        </span>
                    </h1>
                    <p className="mb-4 text-lg leading-relaxed">{body}</p>
                    <span className="wc-badge wc-badge-neutral text-xs">
                        {lastUpdated}
                    </span>
                </div>
            </div>
