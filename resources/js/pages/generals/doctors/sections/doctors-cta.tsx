// resources/js/pages/user/doctors/sections/DoctorsCtaSection.tsx
import { Link } from "@inertiajs/react";
import { useInView } from "@/hooks/useInView";
import { doctorsCtaData } from "./doctors-data";
...
export default function DoctorsCtaSection() {
  ...
  const { pill, heading, desc, ctas } = doctorsCtaData;
        ...
        >
          ...
          <div className="relative z-10 max-w-[600px] mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                <VideoIcon /> {ctas.secondary.label}
              </Link>
            </div>
          </div>
        </div>
