...
export default function DoctorsGridSection({ doctors }: DoctorsGridProps) {
    ...
    // Filter pills are derived from the roster actually in the database, so they
    ...
    const filtered = useMemo(() => {
        ...
        return doctors.filter((d) => {
            ...
            const matchesSearch =
                ...
                specialtyLabel(d.specialty).toLowerCase().includes(q);
        ...
        <section className="wc-section bg-[var(--wc-gray-50)]">
            <div className="wc-container">
                ...
                >
                    ...
                    {filtered.length !== 1 ? 's' : ''}
                    {activeSpecialty !== 'All'
                        ? ` in ${specialtyLabel(activeSpecialty)}`
                        : ''}
