...
export const aboutHeroData = {
    pill: 'Our Story',
    heading: {
        plain: 'Caring for Your Health and Wellness',
        gradient: 'Since 1996.',
    },
    ...
    values: [
        {
            emoji: '💙',
            title: 'Compassion',
            desc: 'We treat every patient as family — with patience, empathy, and respect.',
        },
        {
            emoji: '🔬',
            title: 'Precision',
            desc: 'Rigorous quality control so every result you receive is one you can rely on.',
        },
        {
            emoji: '🤝',
            title: 'Integrity',
            desc: 'Transparent pricing, honest communication, and no unnecessary procedures.',
        },
        {
            emoji: '⚡',
            title: 'Timeliness',
            desc: 'We respect your time. Most results are available within 24 hours.',
        },
        {
            emoji: '🌱',
            title: 'Innovation',
            desc: 'Continuously investing in the latest diagnostic technology and clinical training.',
        },
        {
            emoji: '🏘️',
            title: 'Community',
            desc: 'Deeply rooted in Cavite and Laguna — giving back through outreach and the PhilHealth YAKAP program.',
        },
    ],
};
    ...
    items: [
        {
            ...
            desc: 'Accredited provider for PhilHealth YAKAP and standard reimbursement programs.',
        },
        {
            icon: '🏥',
            title: 'DOH Licensed',
            desc: 'Fully licensed by the Department of Health for clinical and laboratory operations.',
        },
        {
            icon: '🧪',
            title: 'Drug Test Accredited',
            desc: 'DOH-accredited facility for mandatory and voluntary drug testing services.',
        },
        {
            icon: '⚕️',
            title: 'PMA Member',
            desc: 'Affiliated with the Philippine Medical Association and local medical societies.',
        },
    ],
};
