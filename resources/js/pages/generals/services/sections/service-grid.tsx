    ...
    return (
        <section className="wc-section bg-[var(--wc-gray-50)]">
            <div className="wc-container">
                ...
                <div
                    ref={ref}
                    className="mx-auto mb-12 max-w-[640px] text-center transition-all duration-700"
                    style={{
                        opacity: inView ? 1 : 0,
                        transform: inView
                            ? 'translateY(0)'
                ...
                >
                    <span className="wc-pill wc-pill-primary">
                        All Services
                    </span>
                    <h2 className="mt-4 mb-4 text-[clamp(1.875rem,3.5vw,2.25rem)]">
                        Everything You Need,{' '}
                        <span className="wc-gradient-text">Under One Roof</span>
                    </h2>
                    <p
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {servicesData.map((s, i) => (
                        ...
                        >
                            <div className="wc-card-body flex flex-1 flex-col">
                                {/* Icon + title */}
                                <div
                                    className={`wc-icon-tile wc-icon-tile-lg wc-icon-tile-${s.color} mb-5`}
                                >
                                    {ICONS[s.iconKey]}
                                </div>
