  ...
  return (
    <section className="wc-section bg-[var(--wc-gray-50)]">
      <div className="wc-container">
        ...
        <div
          ref={ref}
          className="text-center max-w-[600px] mx-auto mb-16 transition-all duration-700"
          style={{
            opacity: inView ? 1 : 0,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          {steps.map((step, i) => (
            ...
            >
              {/* Step number circle */}
              <div
                className="relative w-16 h-16 rounded-full flex items-center justify-center font-display font-extrabold text-xl mb-5 z-10"
                style={{
