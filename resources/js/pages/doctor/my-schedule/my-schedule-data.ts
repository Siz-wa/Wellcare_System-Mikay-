...
export const QUICK_TASKS: QuickTask[] = [
    {
        id: 'qt1',
        label: "Review Sarah's Lab Results",
        time: '10:00 AM',
        done: false,
    },
    {
        id: 'qt2',
        label: 'Approve Refill for Michael',
        time: '11:30 AM',
        done: false,
    },
    {
        id: 'qt3',
        label: "Prepare for Emma's Surgery",
        time: '01:00 PM',
        done: false,
    },
];
...
export const SCHEDULE_META = {
    ...
    // Identity comes from the shared auth props via AppTopbar, not from here.
};
