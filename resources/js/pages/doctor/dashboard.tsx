...
import { StatCards, AppointmentList, PatientActivity, PendingLabReviews } from "./components";
        ...
        <div style={{
          ...
          <div>
            <h1 style={{
              ...
              {meta.greeting} <span style={{ color: "#1a73e8" }}>{meta.greetingName}</span>
            </h1>
            <p style={{ margin: "4px 0 0 0", color: "#70757a", fontSize: "15px" }}>
              {meta.subtitle}
            </p>
          </div>
