    ...
    >
      <defs>
        <linearGradient id="activityGrad" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%"   stopColor="var(--wc-blue-600)" stopOpacity="0.18" />
          <stop offset="100%" stopColor="var(--wc-blue-600)" stopOpacity="0"    />
        </linearGradient>
      </defs>
      ...
      {gridValues.map((v) => {
        ...
        return (
          <g key={v}>
            <line x1={padX} y1={y} x2={W - padX} y2={y} stroke="#f1f3f4" strokeWidth="1" />
            <text x={0} y={y + 4} fontSize="11" fill="#9aa0a6" textAnchor="start" fontFamily="Inter, sans-serif">
              {v}
            </text>
          </g>
        );
