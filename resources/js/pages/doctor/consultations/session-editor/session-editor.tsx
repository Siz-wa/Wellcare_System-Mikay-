      ...
      >
        <div style={{
          ...
          <div style={{
            ...
            borderBottom: "1px solid var(--wc-gray-100)", flexShrink: 0,
          }}>
            ...
            <button
              ...
              style={{
                ...
                border: "1px solid var(--wc-gray-200)", background: "var(--wc-white)",
                color: "var(--wc-gray-500)", cursor: "pointer", flexShrink: 0,
              }}
            >
              <IconX />
            </button>
              ...
              <div style={{ marginTop: "auto", paddingTop: "var(--space-4)", borderTop: "1px solid var(--wc-gray-100)" }}>
                <button
                  ...
                  style={{
                    ...
                    color: "var(--wc-gray-500)", fontSize: "var(--text-xs)",
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "var(--space-3)" }}>
              ...
              <button
                ...
                style={{ display: "flex", alignItems: "center", gap: "var(--space-2)", opacity: saving ? 0.6 : 1 }}
              >
                <IconVitals />
                {meta.finalizeLabel}
              </button>
