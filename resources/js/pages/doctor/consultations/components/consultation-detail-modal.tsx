    ...
    return (
        <div
            style={{
                ...
                background: hasValue ? 'var(--wc-white)' : 'var(--wc-gray-50)',
            }}
        >
            <p
                style={{
                ...
                {loading ? (
                    ...
                    >
                        {history.map((visit) => {
                            ...
                            const hasSoap =
                                visit.soap &&
                                Object.values(visit.soap).some((v) =>
                                    v?.trim(),
                                );
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        borderRadius: '12px',
                                        border: `1px solid ${isOpen ? 'var(--wc-blue-200)' : 'var(--wc-gray-100)'}`,
                                        overflow: 'hidden',
...
export function ConsultationDetailModal({
    ...
    const statusLabel =
        consultation.rawStatus === 'checked_in'
            ? 'Checked In'
            : consultation.rawStatus === 'in_progress'
              ? 'In Progress'
              : 'Completed';

    const statusColor =
        consultation.rawStatus === 'completed'
                        ...
                        >
                            <div
                                style={{
                                    ...
                                    height: 48,
                                    borderRadius: '12px',
                                    background: consultation.avatarColor,
                                    display: 'flex',
                                    alignItems: 'center',
                                    justifyContent: 'center',
                                    fontSize: '17px',
