...
import { IconXSmall, IconCheck } from "../../../icons/index";
...
export function Prescription({ medications, onAdd, onRemove }: PrescriptionProps): ReactElement {
    ...
    <div style={{ flex: 1 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          borderBottom:   medications.length > 0 || showForm ? "1px solid var(--wc-gray-100)" : "none",
        }}>
          <p style={{ margin: 0, fontSize: "var(--text-sm)", fontWeight: 700, color: "var(--wc-dark)" }}>
        ...
        {showForm && (
          <div style={{ padding: "var(--space-4) var(--space-5)", borderBottom: "1px solid var(--wc-gray-100)" }}>
            <input
              type="text"
              className="wc-input"
            ...
            <input
              ...
              value={newInstr}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewInstr(e.target.value)}
