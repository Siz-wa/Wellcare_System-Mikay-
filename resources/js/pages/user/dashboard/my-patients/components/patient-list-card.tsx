// resources/js/pages/user/my-patients/patient-list-card.tsx
// ─────────────────────────────────────────────────────────────────────────────
// Patient List card — search bar, filter button, table of patients.
// Pure display component; all content sourced from my-patients-data.ts.
...
function PatientRow({ patient, isLast }: { patient: Patient; isLast: boolean }): ReactElement {
...
export function PatientListCard(): ReactElement {
  const meta = myPatientsMeta;
