    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    {appt.status === 'pending_hmo_approval' && (
                        <p
                            style={{
                                margin: 0,
                        ...
                        >
                            HMO coverage is being verified
                        </p>
                    )}
            ...
            >
                ...
                >
                    <div>
                        ...
                        >
                            {totalRecords}{' '}
                            {totalRecords === 1 ? 'record' : 'records'} across{' '}
                            {groups.length}{' '}
                            {groups.length === 1 ? 'patient' : 'patients'}
                        </p>
                    </div>
                    <button
                        onClick={close}
                                        ...
                                        {group.records.map((record, ri) => (
                                            <button
                                                ...
                                                style={{
                                                    width: '100%',
                                                    padding:
                                                        'var(--space-4) var(--space-6) var(--space-4) calc(var(--space-6) + 50px)',
                                                    display: 'flex',
                                                    alignItems: 'center',
                                                    gap: 'var(--space-4)',
                                                    background: 'transparent',
...
export default function PatientDashboard(): ReactElement {
    ...
    const totalPast = props.pastByPatient.reduce(
        (s, g) => s + g.records.length,
        0,
    );
                        ...
                        {totalPast > 0 && (
                            <button
                                ...
                                style={{
                                    ...
                                    background: 'transparent',
                                    color: 'var(--wc-blue-600)',
                                    border: '1px solid var(--wc-blue-200)',
                                    cursor: 'pointer',
                                    fontSize: 'var(--text-sm)',
                                    fontWeight: 700,
                                    display: 'flex',
