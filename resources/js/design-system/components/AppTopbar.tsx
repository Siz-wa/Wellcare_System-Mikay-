...
// AND resources/js/layouts/app/AppTopbar.tsx  ← keep both files identical
// ─────────────────────────────────────────────────────────────────────────────
// Shared topbar for ALL dashboard roles (doctor, patient, HR).
// Reads user identity and flash messages from Inertia shared props.
//
// FIX: FlashToast is now present in this file so it works regardless of which
//      import alias the layout uses (@/design-system/... vs @/layouts/app/...).
...
export function AppTopbar({ searchPlaceholder = "Search…" }: AppTopbarProps): ReactElement {
      ...
      >
        ...
        <div style={{ flex: 1, position: "relative", maxWidth: 420 }}>
          <span style={{
            ...
            transform: "translateY(-50%)", color: "var(--wc-gray-400)",
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "var(--space-3)" }}>
          ...
          {/* Divider */}
          <div style={{ width: 1, height: 28, background: "var(--wc-gray-200)" }} />
          ...
          <div
            style={{
              ...
              borderRadius: "var(--radius-xl)", transition: "background 0.15s",
            }}
            onMouseEnter={e => { (e.currentTarget as HTMLDivElement).style.background = "var(--wc-gray-100)"; }}
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{
                ...
                color: "var(--wc-dark)", lineHeight: 1.2, whiteSpace: "nowrap",
              }}>
                {displayName}
              </span>
              {roleLabel && (
                <span style={{ fontSize: "10px", color: "var(--wc-gray-400)", lineHeight: 1.3, fontWeight: 500 }}>
                  {roleLabel}
                </span>
              )}
            </div>
