...
// ─── CTA button ───────────────────────────────────────────────────────────────
// Reads auth state from Inertia shared props.
// Guest  → "Log In"           → login.url()
// Authed → "Book Appointment" → book.url()
...
export default function Navbar({ active }: NavbarProps) {
  ...
  // Derive active label from current Inertia URL if not explicitly passed
