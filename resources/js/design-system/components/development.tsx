...
const Mascot = () => (
    ...
    >
        ...
        {/* Coat lapels */}
        <path
            d="M110 155 L92 175 L100 175 L110 165 L120 175 L128 175 Z"
            fill="var(--wc-blue-50)"
            stroke="var(--wc-blue-100)"
            strokeWidth="1"
        />
        {/* Stethoscope */}
        <path
            d="M93 168 Q88 178 92 185 Q96 192 103 190"
            stroke="var(--wc-sky-500)"
            strokeWidth="2.5"
            strokeLinecap="round"
            fill="none"
        />
        ...
        <text x="155" y="55" fontSize="16" fill="#ca8a04" opacity="0.8">
            ✦
        </text>
        <text
            x="45"
        ...
        <text x="168" y="100" fontSize="10" fill="#fca5a5" opacity="0.8">
            ✦
        </text>
        <text
            x="38"
    ...
    return (
        <WellcareLayout activeNav={activeNav}>
            <section className="wc-section">
                <div className="wc-container mx-auto max-w-[560px] text-center">
                    {/* Mascot */}
                    ...
                    {/* Heading */}
                    <h1 className="mb-4 text-[clamp(1.875rem,4vw,2.25rem)]">
                        {title}
                    </h1>
                    ...
                    {eta && (
                        <div
                            className="mb-6 inline-flex items-center gap-2 rounded-[var(--radius-full)] px-4 py-2 text-sm font-semibold"
                            style={{
